...
exports.blogsRouter.post('/', authorization_1.authorizationValidationMiddleware, (0, express_validator_1.body)('name').isLength({ max: 15 }).withMessage("name  is too long"), (0, express_validator_1.body)("description").isString().isLength({ max: 500 }).withMessage("description is too long"), (0, express_validator_1.body)("websiteUrl").isString().isLength({ max: 100 }).withMessage("websiteUrl is too long"), (0, express_validator_1.body)("websiteUrl").isURL().withMessage("website url does not match the template"), input_validation_middleware_1.inputValidationMiddleware, (req, res) => {
