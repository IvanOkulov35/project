...
exports.postsRouter.post('/', authorization_1.authorizationValidationMiddleware, (0, express_validator_1.body)('title').isString().isLength({ max: 30 }).withMessage("post is too long"), (0, express_validator_1.body)("shortDescription").isString().isLength({ max: 100 }).withMessage("shortDescription is too long"), (0, express_validator_1.body)("content").isString().isLength({ max: 1000 }).withMessage("content is too long"), (0, express_validator_1.body)("blogId").isString().notEmpty().withMessage("incorrect blogId").custom((id, req) => {
